...
declare module PIXI {
    ...
    export function autoDetectRenderer(width: number, height: number, options?: PIXI.RendererOptions, noWebGL?: boolean): PIXI.SystemRenderer;
    ...
    export class DisplayObject extends EventEmitter implements interaction.InteractiveTarget {
        ...
        generateTexture(renderer: SystemRenderer, scaleMode: number, resolution: number): Texture;
        destroy(): void;
    ...
    export class Container extends DisplayObject {
        ...
        generateTexture(renderer: SystemRenderer, resolution?: number, scaleMode?: number): Texture;
    ...
    export class GraphicsData {
        ...
        constructor(lineWidth: number, lineColor: number, lineAlpha: number, fillColor: number, fillAlpha: number, fill: boolean, shape: HitArea);
    ...
    export class Graphics extends Container {
        ...
        drawShape(shape: HitArea): GraphicsData;
    ...
    export class CanvasMaskManager {
        ...
        pushMask(maskData: any, renderer: SystemRenderer): void;
        popMask(renderer: SystemRenderer): void;
        destroy(): void;
    ...
    export class WebGLRenderer extends SystemRenderer {
        ...
        updateTexture(texture: BaseTexture): BaseTexture;
        destroyTexture(texture: BaseTexture): void;
    ...
    export class AbstractFilter {
        ...
        constructor(vertexSrc?: any, fragmentSrc?: any, uniforms?: any);
    ...
    export class BaseTexture extends EventEmitter {
        ...
        constructor(source: any, scaleMode?: number, resolution?: number);
    ...
    export class Texture extends BaseTexture {
        ...
        static fromVideo(video: any, scaleMode?: number): Texture;
    ...
    export class VideoBaseTexture extends BaseTexture {
        ...
        static fromUrl(videoSrc: any): VideoBaseTexture;
    ...
    export module extras {
        ...
        export class TilingSprite extends Sprite {
            ...
            getBounds(): Rectangle;
            generateTilingTexture(renderer: SystemRenderer, texture: Texture, forcePowerOfTwo?: boolean): Texture;
            containsPoint(point: Point): boolean;
            destroy(): void;
    ...
    export module interaction {
        ...
        export class InteractionManager {
            ...
            constructor(renderer: SystemRenderer, options?: { autoPreventDefault?: boolean; interactionFrequence?: number; });
    ...
    export module loaders {
        ...
        export class Resource extends EventEmitter {
            ...
            constructor(name?: string, url?: any, options?: LoaderOptions);
